...
function showRegisterForm(){
    ...
    $('.loginBox').fadeOut('fast',function(){
        ...
        $('.modal-subtitle').html('Begin a 30-day free trial');
    });
...
$(".mailchimp-subscribe").ajaxChimp({
    ...
    url: "http://samelogic.us13.list-manage.com/subscribe/post?u=53c708c48762d1f703dff53e4&amp;id=410a0f26c3" // Replace your mailchimp post url inside double quote "".  
});
...
========================================================================== */
    ...
    var material = new FSS.Material('9013FE', '9013FE');
