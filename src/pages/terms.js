              ...
              <Col lg="9" xl="8">
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <List>
                    ...
                    <li>
                      ...
                      our Service’s attributes, performance, or features.
                    </li>
                    ...
                    <li>
                      ...
                      subscription basis by the Company.
                    </li>

                    <li>
                      Terms of Service (also referred to as "Terms") mean these Terms and
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    compliance with these Terms of Service. These Terms of Service apply
                    to all visitors, users, and others who access or use the Service.
                  </Text>
                  <Text variant="small" mb="10px">
                    By accessing or using the Service, You agree to be bound by these Terms and
                    Conditions. If You disagree with any part of these Terms of Service, then.
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    of and compliance with the Company's Privacy Policy. Our Privacy Policy
                    describes Our policies and procedures on the collection, use, and disclosure of
                    When you use the Application or the Website, your personal information
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    The subscription plan you select when purchasing the Subscription.
                  </Text>
                  <Text variant="small" mb="10px">
                  ...
                  <Text variant="small" mb="10px">
                    You may cancel Your Subscription renewal either through Your Account settingspage 
                    or by contacting the Company. You will not receive a refund for the feesYou have 
                    already paid for Your current subscription period, and You will be able toaccess 
                    the Service until the end of Your current subscription period.
                  </Text>
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    Subscription fees to allow You to terminate Your Subscription
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    a case-by-case basis and granted at the Company's sole discretion.
                  </Text>
                  ...
                  <Text variant="small" mb="10px">
                    You may be required to enter Your billing information to sign up for
                    the Free Trial.
                  </Text>
                  <Text variant="small" mb="10px">
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    the Terms of Service of the Free Trial offer, or (ii) cancel such Free
                    Trial offer.
                  </Text>
                </Box>
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    wish to terminate Your Account; you may discontinue using the Service.
                  </Text>
                </Box>
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <Text variant="small" mb="10px">
                    Some states do not exclude implied warranties or limitation of
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    under applicable law, the Company, on its own behalf and behalf of its
                    Affiliates and it's and their respective licensors and service providers,
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    the exclusions and limitations outlined in this section shall be applied to
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <Text variant="small" mb="10px">
                    If You have any concern or dispute about the Service, You agree first to try
