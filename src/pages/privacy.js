            ...
            <Row className="justify-content-center">
              <Col lg="9" xl="8">
                ...
                <Text variant="small">
                  ...
                  information by this Privacy Policy.
                </Text>
                ...
                <Box mt={['40px', null, '50px']}>
                  ...
                  <List>
                    ...
                    <li>
                      ...
                      Agreement) refers to Samelogic, Inc., 8 The Green STE B
                      Dover DE 19901.
                    </li>
                    <li>
                      ...
                      domiciled in the USA, which is outside the USA for a
                ...
                <Box mt={['40px', null, '50px']}>
                  ...
                  <Text variant="small" mb="10px">
                    ...
                    information with the The company through Your Third-Party
                ...
                <Box mt={['40px', null, '50px']}>
                  ...
                  <List>
                    ...
                    <li>
                      Firebase Firebase is an analytics service provided by
                      Google Inc.
                      <br />
                      <br />
                    ...
                    <li>
                      ...
                      for Clicky here: https://clicky.com/terms
                    </li>
                    <li>
                      Statcounter
                      <br />
                    ...
                    <li>
                      ...
                      of Yahoo!, please visit their Privacy Policy page:
                    ...
                    <li>
                      ...
                      personalized advertising services. For more information on
                      what type of information Unity Technologies collects,
                      please visit their Privacy Policy page:
                      https://unity3d.com/legal/privacy-policy
                      <br />
                      <br />
                      You can prevent Unity Analytics from using your
                      information by opting-out. To opt-out of Unity Analytics,
                    ...
                    <li>
                      ...
                      <br />
                      <br />
                      Their Privacy Policy can be viewed at https://ahrefs.com/
                    </li>
                  </List>
                  ...
                  <List>
                    ...
                    <li>
                      ...
                      <br />
                      <br />
                      GetResponse is an email marketing sending service provided
                      by GetResponse.
                      <br />
                      <br />
                      For more information on the privacy practices of
                ...
                <Box mt={['40px', null, '50px']}>
                  ...
                  <List>
                    <li>
                      Category A: Identifiers. Examples: A real name, alias,
                      postal address, unique personal identifier, online
                      identifier, Internet Protocol address, email address,
                      account name, driver's license number, passport number, or
                    ...
                    <li>
                      ...
                      1798.80(e)). Examples: A name, signature, Social Security
                    ...
                    <li>
                      ...
                      California or federal law. Examples: Age (40 years or
                      older), race, color, ancestry, national origin,
                    ...
                    <li>
                      Category D: Commercial information. Examples: Records and
                      history of products or services purchased or considered.
                      Collected: Yes.
                    </li>
                    <li>
                      Category E: Biometric information. Examples: Genetic,
                      physiological, behavioral, and biological characteristics,
                      or activity patterns used to extract a template or other
                      ...
                      sleep, health, or exercise data. Collected: No.
                    </li>
                    <li>
                    ...
                    <li>
                      Category G: Geolocation data. Examples: Approximate
                      physical location. Collected: No.
                    </li>
                    <li>
                      Category H: Sensory data. Examples: Audio, electronic,
                      visual, thermal, olfactory, or similar information.
                      Collected: No.
                    </li>
                    <li>
                      Category I: Professional or employment-related
                      information. Examples: Current or past job history or
                    ...
                    <li>
                      ...
                      Section 1232g, 34 C.F.R. Part 99)). Examples: Education
                      ...
                      information, or student disciplinary records. Collected:
                      No.
                    </li>
                    <li>
                      Category K: Inferences drawn from other personal
                      information. Examples: Profile reflecting a person's
                  ...
                  <List>
                    ...
                    <li>
                      ...
                      vendors for payment processing, or other third-party
                  ...
                  <List>
                    <li>
                      ...
                      which categories of Personal Data are being collected and
